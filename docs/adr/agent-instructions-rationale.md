...
| Spec, ticket, triage, and wayfinding settings | On-demand workflow configuration | `.agents/workflow.local.md` (private override); `.agents/workflow.md` (shared); `ai-agents/claude/skills/setup-agent-skills/SKILL.md` |
