...
- **Report-first on requests**. When asked to do something, open by stating whether it's done, not done, or partially done; if not done, say why before adding detail. Use bullet or numbered lists over prose paragraphs when they improve clarity.
