...
Output location and any tracker/wiki target come from repository-root `agent-skills.md` — run `/setup-agent-skills` if absent. Default: `docs/design/<slug>.md` (`<slug>` = kebab-cased title, no date prefix).
