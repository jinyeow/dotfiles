if get(g:, 'airline#themes#base16#constant', 0)
  ...
  let g:airline#themes#base16#palette.inactive_modified = {
        ...
        \ }
else " NOTE: colors are set according to the below
  function! airline#themes#b16#refresh()
    let g:airline#themes#b16#palette = {}

    let g:airline#themes#b16#palette.accents = {
          \ 'red': airline#themes#get_highlight('Constant'),
          \ }

    let s:N1 = airline#themes#get_highlight2(['GitGutterChangeDelete', 'bg'], ['Question', 'fg'], 'bold')
    let s:N2 = airline#themes#get_highlight2(['Visual', 'fg'], ['Visual', 'bg'])
    let s:N3 = airline#themes#get_highlight('Question')
    let g:airline#themes#b16#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)

    let group = airline#themes#get_highlight('vimCommand')
    let g:airline#themes#b16#palette.normal_modified = {
          \ 'statusline': [ group[0], '', group[2], '', '' ]
          \ }

    let s:I1 = airline#themes#get_highlight2(['GitGutterChangeDelete', 'bg'], ['DiffAdded', 'fg'], 'bold')
    let s:I2 = airline#themes#get_highlight2(['DiffAdded', 'fg'], ['Normal', 'bg'])
    " let s:I3 = s:N3
    let s:I3 = airline#themes#get_highlight2(['DiffAdded', 'fg'], ['GitGutterChangeDelete', 'bg'])
    let g:airline#themes#b16#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
    let g:airline#themes#b16#palette.insert_modified = g:airline#themes#b16#palette.normal_modified

    let s:R1 = airline#themes#get_highlight2(['GitGutterChangeDelete', 'bg'], ['WarningMsg', 'fg'], 'bold')
    let s:R2 = s:N2
    " let s:R3 = s:N3
    let s:R3 = airline#themes#get_highlight2(['WarningMsg', 'fg'], ['GitGutterChangeDelete', 'bg'])
    let g:airline#themes#b16#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)
    let g:airline#themes#b16#palette.replace_modified = g:airline#themes#b16#palette.normal_modified

    let s:V1 = airline#themes#get_highlight2(['GitGutterChangeDelete', 'bg'], ['Constant', 'fg'], 'bold')
    let s:V2 = airline#themes#get_highlight2(['Constant', 'fg'], ['Normal', 'bg'])
    let s:V3 = s:R3
    let g:airline#themes#b16#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
    let g:airline#themes#b16#palette.visual_modified = g:airline#themes#b16#palette.normal_modified

    let s:IA = airline#themes#get_highlight2(['NonText', 'fg'], ['CursorLine', 'bg'])
    let g:airline#themes#b16#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
    let g:airline#themes#b16#palette.inactive_modified = {
          \ 'airline_c': [ group[0], '', group[2], '', '' ]
          \ }

    " Warnings
    let s:WI = airline#themes#get_highlight2(['WarningMsg', 'bg'], ['WarningMsg', 'fg'], 'bold')
    let g:airline#themes#b16#palette.normal.airline_warning = [
         \ s:WI[0], s:WI[1], s:WI[2], s:WI[3]
         \ ]

    let g:airline#themes#b16#palette.normal_modified.airline_warning =
        \ g:airline#themes#b16#palette.normal.airline_warning


    let g:airline#themes#b16#palette.insert.airline_warning =
        \ g:airline#themes#b16#palette.normal.airline_warning

    let g:airline#themes#b16#palette.insert_modified.airline_warning =
        \ g:airline#themes#b16#palette.normal.airline_warning

    let g:airline#themes#b16#palette.visual.airline_warning =
        \ g:airline#themes#b16#palette.normal.airline_warning

    let g:airline#themes#b16#palette.visual_modified.airline_warning =
        \ g:airline#themes#b16#palette.normal.airline_warning

    let g:airline#themes#b16#palette.replace.airline_warning =
        \ g:airline#themes#b16#palette.normal.airline_warning

    let g:airline#themes#b16#palette.replace_modified.airline_warning =
        \ g:airline#themes#b16#palette.normal.airline_warning

  endfunction
  call airline#themes#b16#refresh()
endif
