...
| Agent workflow configuration | [`.agents/workflow.md`](.agents/workflow.md); [`ai-agents/claude/skills/setup-agent-skills/SKILL.md`](ai-agents/claude/skills/setup-agent-skills/SKILL.md) |
...
agents remain under [`claude/agents/`](claude/agents/); portable skills remain under
[`ai-agents/shared/skills/`](ai-agents/shared/skills/), Claude-only skills under
[`ai-agents/claude/skills/`](ai-agents/claude/skills/), and only portable skills are
projected to Codex by the installer.
Lane-specific rehoming/projection work is out of scope here.
