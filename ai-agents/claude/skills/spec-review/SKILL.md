...
1. Issue references in the commit messages (`#123`, `Closes #45`, Azure Boards `AB#123`) — fetch via the tracker in the repo's Agent-skills config (`/setup-agent-skills` if absent).
